...
| `mcp-wrapper` | Yes | Registers tools from configured MCP servers as Pi tools, caches MCP tool metadata for faster startup. |
...
- https://github.com/n-r-w/team-mcp collaboration desk for subagents.
